...
Author: Manasa
Date:10-17-2015
Package/ Module: Doctor 
Functionality: A page where doctor can login into application with user name and password
--%>
...
<center>
		 <form name="f1" method="post" action="DoctorLogin" onsubmit="return validate(this);">
   <h1 align="center"><font size="" color="#FFF">Doctor Login Form</h1><br/>
