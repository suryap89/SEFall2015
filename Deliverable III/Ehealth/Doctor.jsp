...
Functionality:  A page where doctor sign up for the application.
--%>
...
<center>
   ...
   <h1 align="center"><font size="" color="#FFF">Doctor Registration</h1><br/>
...
<tr><td><font size="" color="#FFF"><b>Registration No</b></td><td><input type="text" name="t8"/></td></tr>
