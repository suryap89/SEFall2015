...
Functionality: Login page for hospital to sing in.
--%>
...
<center>
		 <form name="f1" method="post" action="HospitalLogin" onsubmit="return validate(this);">
   <h1 align="center"><font size="" color="#FFF">Hospital Login Form</h1><br/>
