...
Functionality: A page where admin can accept request from doctor to join the application.
--%>
...
<li  class="active"><a href="DoctorRequest.jsp">Doctor Request</a></li>
...
<center>
   ...
   <h1 align="center"><font size="" color="#FFF">Doctor Request Form</h1><br/>
...
<%
			 ...
			 ResultSet rs = stmt.executeQuery("select * from adddoctor where status='pending'");
			 while(rs.next()){
				 ...
				 <td><%=s10%></td>
				 <td><%=s11%></td>
<td><a href="ApprovedDoctor?t1=<%=s9%>">Click Here</a></td>
				 <%}%>
			 </select>
