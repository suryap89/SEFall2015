...
<%-- 
Title: RegisterPrescription
Author: Divya
Date:10-23-2015
Package/ Module: User
Functionality: A web page for registered user to go on to request for prescription.
--%>
...
<center>
		 <form name="f1" method="post" action="RegisterPrescription" onsubmit="return validate(this);">
