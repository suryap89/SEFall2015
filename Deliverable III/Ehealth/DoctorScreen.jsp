...
Functionality: A page for doctor to do their assigned tasks.
--%>
...
<center>
   ...
   <h1 align="center"><font size="" color="#FFF">View Doctor Form</h1><br/>
...
String user = session.getAttribute("user").toString();
			 ...
			 ResultSet rs = stmt.executeQuery("select * from adddoctor where username='"+user+"'");
			 while(rs.next()){
